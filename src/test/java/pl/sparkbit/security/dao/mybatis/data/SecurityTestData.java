...
public class SecurityTestData {
    ...
    public static final Operation CREDS_1 = CompositeOperation.sequenceOf(
            SecurityTestDataUtils.user(Credentials.builder().userId(CREDS_1_USER_ID).password(CREDS_1_PASSWORD)
                    .enabled(CREDS_1_ENABLED).deleted(CREDS_1_DELETED).build()),
            SecurityTestDataUtils.role(CREDS_1_USER_ID, ROLE_USER), SecurityTestDataUtils.role(CREDS_1_USER_ID, ROLE_ADMIN));
    ...
    public static final Operation CHALLENGE_1 = SecurityTestDataUtils.securityChallenge(CHALLENGE_1_ID, CREDS_1_USER_ID, CHALLENGE_1_TYPE,
    ...
    public static final Operation SIMPLE_LOGIN_USER_1 = SecurityTestDataUtils.simpleLoginUser(USER_1_ID, USER_1_USERNAME);
    public static final Operation COMPOSITE_LOGIN_USER_1 =
            SecurityTestDataUtils.compositeLoginUser(USER_1_ID, USER_1_USERNAME, USER_1_CONTEXT);
}
