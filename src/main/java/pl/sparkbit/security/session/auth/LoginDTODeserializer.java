...
import pl.sparkbit.security.session.auth.social.FacebookLoginDTO;
import pl.sparkbit.security.session.auth.social.GoogleLoginDTO;
import pl.sparkbit.security.session.auth.social.TwitterLoginDTO;
